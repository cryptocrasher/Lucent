...
Value dumpprivkey(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"lucentaddress\"\n"
            "\nReveals the private key corresponding to 'lucentaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"lucentaddress\"   (string, required) The lucent address for the private key\n"
            "\nResult:\n"
...
Value dumpwallet(const Array& params, bool fHelp)
{
    ...
    // produce output
    file << strprintf("# Wallet dump created by Lucent %s (%s)\n", CLIENT_BUILD, CLIENT_DATE);
...
Value bip38encrypt(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38encrypt \"lucentaddress\"\n"
            "\nEncrypts a private key corresponding to 'lucentaddress'.\n"
            "\nArguments:\n"
            "1. \"lucentaddress\"   (string, required) The lucent address for the private key (you must hold the key already)\n"
