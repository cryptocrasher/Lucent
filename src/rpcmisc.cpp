...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total lucent balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zLUCENTsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zLUCENT denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zLUCENT denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zLUCENT denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zLUCENT denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zLUCENT denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zLUCENT denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zLUCENT denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zLUCENT denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zLUCENT denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in lucent/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in lucent/kb\n"
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zLUCENTObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zLUCENTObj.emplace_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.emplace_back(Pair("zLUCENTsupply", zLUCENTObj));
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"lucentaddress\"\n"
            "\nReturn information about the given lucent address.\n"
            "\nArguments:\n"
            "1. \"lucentaddress\"     (string, required) The lucent address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"lucentaddress\", (string) The lucent address validated\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"lucentaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"lucentaddress\"  (string, required) The lucent address to use for the signature.\n"
