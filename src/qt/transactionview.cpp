                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received LUCENT from zLUCENT"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zLUCENT"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zLUCENT));
