...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted LUCENT to zLUCENT");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zLUCENT");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received LUCENT from zLUCENT");
    case TransactionRecord::ZerocoinSpend_Change_zLUCENT:
        return tr("Minted Change as zLUCENT from zLUCENT Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zLUCENT to LUCENT");
