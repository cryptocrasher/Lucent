...
public:
    ...
    void setZLUCENTControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzLUCENT_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzLUCENT_clicked();
    void on_pushButtonZLUCENTControl_clicked();
