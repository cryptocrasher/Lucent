                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Lucent Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zLUCENT"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Lucent Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Lucent"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Lucent Core help message to get a list with possible Lucent command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Lucent Core client") + " " + networkStyle->getTitleAddText();
