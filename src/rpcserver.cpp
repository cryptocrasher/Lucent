...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Lucent features */
        {"lucent", "masternode", &masternode, true, true, false},
        {"lucent", "listmasternodes", &listmasternodes, true, true, false},
        {"lucent", "getmasternodecount", &getmasternodecount, true, true, false},
        {"lucent", "masternodeconnect", &masternodeconnect, true, true, false},
        {"lucent", "masternodecurrent", &masternodecurrent, true, true, false},
        {"lucent", "masternodedebug", &masternodedebug, true, true, false},
        {"lucent", "startmasternode", &startmasternode, true, true, false},
        {"lucent", "createmasternodekey", &createmasternodekey, true, true, false},
        {"lucent", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"lucent", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"lucent", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"lucent", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"lucent", "getmasternodescores", &getmasternodescores, true, true, false},
        {"lucent", "mnbudget", &mnbudget, true, true, false},
        {"lucent", "preparebudget", &preparebudget, true, true, false},
        {"lucent", "submitbudget", &submitbudget, true, true, false},
        {"lucent", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"lucent", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"lucent", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"lucent", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"lucent", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"lucent", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"lucent", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"lucent", "checkbudgets", &checkbudgets, true, true, false},
        {"lucent", "mnsync", &mnsync, true, true, false},
        {"lucent", "spork", &spork, true, true, false},
        {"lucent", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"lucent", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use lucentd, or the -server option to lucent-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
