...
In order to support loading of multiple wallets in lucent-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lucent.cpp.
...
Changes to lucent.cpp
----------------------
lucent.cpp is the entry point into lucent-qt, and as such, will require some minor modifications to provide hooks for
