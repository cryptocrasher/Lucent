...
*Setup instructions for a gitian build of Lucent using a Debian VM or physical system.*
...
- [Building Lucent](#building-lucent)
...
Clone the git repositories for lucent and gitian and then checkout the lucent version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/lucent-crypto/Lucent.git
cd lucent
...
Follow the instructions in [doc/release-process.md](release-process.md) in the lucent repository
...
To build Lucent (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the lucent repository.
...
```bash
    ...
    From https://github.com/lucent-crypto/lucent
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/lucent-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/lucent-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/lucent-build.assert
```
...
[Lucent.gitian.sigs](https://github.com/lucent-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
