...
RESOURCES += src/qt/lucent.qrc src/qt/lucent_locale.qrc

TRANSLATIONS += src/qt/locale/lucent_bg.ts \
                src/qt/locale/lucent_de.ts \
                src/qt/locale/lucent_en.ts \
                src/qt/locale/lucent_es.ts \
                src/qt/locale/lucent_fi.ts \
                src/qt/locale/lucent_fr.ts \
                src/qt/locale/lucent_it.ts \
                src/qt/locale/lucent_ja.ts \
                src/qt/locale/lucent_pl.ts \
                src/qt/locale/lucent_pt.ts \
                src/qt/locale/lucent_ru.ts \
                src/qt/locale/lucent_sk.ts \
                src/qt/locale/lucent_sv.ts \
                src/qt/locale/lucent_vi.ts \
                src/qt/locale/lucent_zh_CN.ts \
                src/qt/locale/lucent_zh_TW.ts
